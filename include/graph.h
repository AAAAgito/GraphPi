...
//bool cmp(loader l1, loader l2) {
//    if (l1.file_id == l2.file_id) {
//        return l1.k_hop > l2.k_hop;
//    }
//    return l1.file_id < l2.file_id;
//}
...
public:
    ...
    ~Graph() {
        ...
        if(inter_vertex != nullptr) delete[] vertex;
        if(inter_edge != nullptr) delete[] vertex;
    ...
    long long pattern_matching_candidate_bin(const Schedule& schedule, int thread_count, bool clique);
...
private:
    ...
    void pattern_matching_candidate_bin_func(const Schedule& schedule, VertexSet* vertex_set, VertexSet& subtraction_set, long long& local_ans, int depth, bool clique);
};
